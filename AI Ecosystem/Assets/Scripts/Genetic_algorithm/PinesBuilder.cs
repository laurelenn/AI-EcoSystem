...
public class PinesBuilder : MonoBehaviour
{
    ...
    public GameObject buildPine(int height, int volume, GameObject terrainX)
    { // Position = (0,0,0)
        return buildPine(new Vector3(0, 0, 0), height, volume, terrainX);
    }

    public GameObject buildPine(Vector3 positionPlant, int height, int volume, GameObject terrainX)
    {
